...
class TestEllipsoidEndpoint:
    ...
    def test_create_ellipsoid_3d(self):
        ...
        pytest.assert_almost_equal(data["additional_properties"]["axis_ratio"], expected_ratio)
    ...
    def test_create_ellipsoid_invalid_axes(self):
        ...
        request_data = {"dimensions": 3, "semi_axes": [1.0, 2.0]}  # Wrong number of axes
        response = client.post("/api/ellipsoid", json=request_data)
...
class TestQueryEndpoint:
    ...
    def test_query_create_simplex(self):
        ...
        data = response.json()
        assert data["success"] is True
        assert ("simplex" in data["response"].lower() or "tetrahedron" in data["response"].lower())
    ...
    def test_query_invalid(self):
        ...
        data = response.json()
        assert data["success"] is True
        assert ("specify" in data["response"].lower() or "error" in data["response"].lower())
...
class TestDimensionEndpoint:
    ...
    def test_dimension_info_3d(self):
        ...
        pytest.assert_almost_equal(data["unit_sphere"]["surface_area"], expected_surface)
...
class TestErrorHandling:
    ...
    def test_invalid_field_types(self):
        ...
        response = client.post("/api/sphere", json={"dimensions": "invalid", "radius": 1.0})
        assert response.status_code == 422
