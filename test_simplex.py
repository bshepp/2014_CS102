...
def test_simplex_basic():
    ...
    try:
        ...
        if abs(actual_surface - expected_surface) < 1e-10:
            ...
            print(f"❌ 2D triangle surface area incorrect: {actual_surface:.6f} vs {expected_surface:.6f}")
        ...
        if abs(actual_volume - expected_volume) < 1e-10:
            ...
            print(f"❌ 3D tetrahedron volume incorrect: {actual_volume:.6f} vs {expected_volume:.6f}")
        ...
        if abs(actual_surface - expected_surface) < 1e-10:
            ...
            print(f"❌ 3D tetrahedron surface area incorrect: {actual_surface:.6f} vs {expected_surface:.6f}")
...
def test_simplex_radii():
    ...
    try:
        ...
        if abs(actual_circumradius - expected_circumradius) < 1e-10:
            ...
            print(f"❌ 2D triangle circumradius: {actual_circumradius:.6f} vs {expected_circumradius:.6f}")
        ...
        if abs(actual_inradius - expected_inradius) < 1e-10:
            ...
            print(f"❌ 2D triangle inradius: {actual_inradius:.6f} vs {expected_inradius:.6f}")
        ...
        if abs(actual_circumradius - expected_circumradius) < 1e-10:
            ...
            print(f"❌ 3D tetrahedron circumradius: {actual_circumradius:.6f} vs {expected_circumradius:.6f}")
        ...
        if abs(actual_inradius - expected_inradius) < 1e-10:
            ...
            print(f"❌ 3D tetrahedron inradius: {actual_inradius:.6f} vs {expected_inradius:.6f}")
