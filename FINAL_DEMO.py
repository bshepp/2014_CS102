...
def demo_hypercube_capabilities():
    ...
    try:
        ...
        for dim in dimensions:
            ...
            print(f"  {dim:2d}D: Vol={volume:8.1f}, Surf={surface:8.1f}, Vertices={vertices:6d}, Edges={edges:6d}")
...
def demo_shape_comparisons():
    ...
    try:
        ...
        for dim in [1, 2, 3, 4, 5, 10, 20]:
            ...
            print(f"  {dim:2d}D: Sphere={sphere_vol:8.4f}, Cube={cube_vol:8.4f}, Ratio={ratio:8.4f}")
        ...
        for dim in [2, 3, 4, 5]:
            ...
            print(f"  {dim}D: Sphere={sphere_surf:8.4f}, Cube={cube_surf:8.4f}, Ratio={ratio:8.4f}")
...
def demo_performance_metrics():
    ...
    try:
        ...
        for dim in dimensions_to_test:
            ...
            print(f"• {dim:3d}D: {elapsed:.4f}s for 1000 shapes ({elapsed*1000:.2f}ms per shape)")
