    ...
    try:
        ...
        if event.get('httpMethod') == 'POST':
            ...
            if method == 'tools/call':
                ...
                # Log to DynamoDB
                try:
                    log_to_dynamodb(tool_name, arguments, result, True, session_id, user_agent)
...
def log_to_dynamodb(tool_name, input_params, output_results, success, session_id=None, client_info=None):
