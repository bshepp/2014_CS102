...
def test_hyperpyramid_basic():
    ...
    try:
        ...
        if abs(actual_volume - expected_volume) < 1e-10:
            ...
            print(
                f"❌ 3D square pyramid volume incorrect: {actual_volume:.6f} vs {expected_volume:.6f}"
            )
        ...
        if abs(actual_surface - expected_surface) < 1e-10:
            ...
            print(
                f"❌ 3D square pyramid surface area incorrect: {actual_surface:.6f} vs {expected_surface:.6f}"
            )
...
def test_cross_sections():
    ...
    try:
        ...
        if abs(cross_section - expected) < 1e-10:
            ...
            print(
                f"❌ Cross-section at half height: {cross_section:.6f} vs {expected:.6f}"
            )
