...
def test_mathematical_accuracy():
    ...
    try:
        ...
        print(f"3D Unit Sphere Volume: {actual_volume:.6f} (expected: {expected_volume:.6f})")
        print(f"Volume difference: {volume_diff:.10f}")
        
        print(f"3D Unit Sphere Surface: {actual_surface:.6f} (expected: {expected_surface:.6f})")
